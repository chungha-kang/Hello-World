...
public class Sample03 {
	...
	public static void main(String[] args) {
		...
		hashSet.add(600); hashSet.add(200); hashSet.add(300);
		hashSet.add(400); hashSet.add(900); hashSet.add(700);
		hashSet.add(300); hashSet.add(100); hashSet.add(800);
		
		linkedHashSet.add(600); linkedHashSet.add(200); linkedHashSet.add(300);
		...
		treeSet.add(600); treeSet.add(200); treeSet.add(300);
