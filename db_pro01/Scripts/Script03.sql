...
-- EMPLOYESS 테이블에서 COMMISSION_PCT 가 NULL 이 아니면서 SALARY 가 10000 이상인
...
-- FIRST_NAME, LAST_NAME 은 하나의 칼럼(EMP_NAME)으로 조회되도록 한다.
SELECT EMPLOYEE_ID
...
-- 되도록 한다.
-- 예) EMPLOYEE_ID 가 100 인 사원은 EMAIL 이 SKING, JOB_ID 가 AD_PRES 이다. 이들 문제에서
