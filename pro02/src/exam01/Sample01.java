...
public class Sample01 {
	...
	public static void main(String[] args) {
		 ...
		 * 		- 강제 형변환 : 자료형의 크기가 큰 자료형에서 작은 자료형으로 변환할 때에는 강제 변환 시켜야 한다.
		 * 
		 * 강제 형변환 방법
		 * 		- 자료형 변환을 할 값 앞에 변환 타입을 작성한다. -> "(자료형)값" 형식으로 작성한다.
		 * 
		 * 강제 형변환에서 주의사항
		 * 		- 자료형이 큰 데이터에서 작은 데이터로 축소되기 떄문에 데이터의 손실을 감수해야 한다.
		...
		short s1 = 10;
		i1 = b1 + s1;	// b1 = byte, s1 = short => byte 와 short 의 계산 결과는 무조건 int
		...
		System.out.println(c2);
		 ...
		 // i2 = f1; 을 바꿔보자
		 i2 = (int)f1;
		 i2 = 10 + (int)f1;		// 정수로 맞춘값
		 i2 = (int)((float)10 + f1); //실수로 맞춘값
