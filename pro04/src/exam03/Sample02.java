...
public class Sample02 {
	...
	public static void main(String[] args) {
		// 1. 배열의 크기가 10 인 정수 배열을 2개 생성 후 각 배열에 10 ~ 99 사이의 난수값으로 초기화 시키고 출력한다.
		...
		*/
		...
		// 3. 2번 문제까지 진행하여 만들어진 3개의 배열을 이용하여 짝수값만 저장되어 있는 배열과 홀수값만 저장되어 있는 배열을 만들고
		//	  짝수 배열과 홀수 배열을 출력 한다.
		...
		*/
		...
		// 4. 짝수/홀수 배열에 있는 값들중 중복된 값이 있는 경우 하나의 값만 남겨 새로운 배열로 만들고 출력 한다.
	int[] arr6 = new int[1];
	int[] arr7 = new int[1];
	int idx3 = 0, idx4 = 0;
