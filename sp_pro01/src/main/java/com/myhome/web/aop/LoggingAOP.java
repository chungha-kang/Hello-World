...
public class LoggingAOP {
	...
	// 조인포인트 설정
//	@Pointcut(value="execution(public String com.myhome.web.board.controller.BoardController.getData(org.springframework.ui.Model, javax.servlet.http.HttpSession))")
