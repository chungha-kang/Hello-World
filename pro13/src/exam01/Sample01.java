...
public class Sample01 {
	...
	public static void main(String[] args) {
		 ...
		 * 		  (영상, 음향, 이미지, 실행파일 등) (txt로 열어보면 뭘 나타내는지 알 수 없다.)
		 */
		 ...
		 */
		File f = new File("C:/Users/Chung/eclipse/jee-2021-12/eclipse/eclipse.ini");
//		System.out.println("파일 크기 : " + f.length() + " Byte");
//		System.out.println("파일 크기 : " + f.length() / 1024.0 + " KByte");
		...
		System.out.printf("읽기 기능 : %s\n", f.canRead());
		System.out.printf("쓰기 기능 : %s\n", f.canWrite());
		...
		File f2 = new File("C:/Users/Chung/eclipse/jee-2021-12/eclipse/my_file.wav");
		try {
			f2.createNewFile();
		} catch (IOException e) {
		...
		File f3 = new File("C:/Users/Chung/eclipse/jee-2021-12/eclipse/my_folder");
		f3.mkdir();
		
		File f4 = new File("C:/Users/Chung/eclipse/jee-2021-12/eclipse/my_file.txt");
		f4.delete();
		
		File f5 = new File("C:/Users/Chung/eclipse/jee-2021-12/eclipse/");
